            ...
            <form action="/crear-cuenta" method="POST">
                ...
                <div class="mb-5">
                    ...
                    <input
                        ...
                        placeholder="Tu Nombre de usuario" class="border p-3 w-full rounded-lg">
                </div>
                ...
                <div class="mb-5">
                    ...
                    <input
                        ...
                        placeholder="Tu email de registro" class="border p-3 w-full rounded-lg">
                </div>
                ...
                <div class="mb-5">
                    ...
                    <input
                        ...
                        placeholder="Tu password de registro" class="border p-3 w-full rounded-lg">
                </div>
